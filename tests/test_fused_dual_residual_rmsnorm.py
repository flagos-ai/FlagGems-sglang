...
"""Correctness test for activation_norm/fused_dual_residual_rmsnorm."""
...
def test_fused_dual_residual_rmsnorm(case_idx):
    ...
    try:
        actual = fused_dual_residual_rmsnorm(**kwargs)
