...
"""Correctness test for lora/sgemm_lora_a."""
...
# ---------------------------------------------------------------------------
# Cases (from kernel-comp-baseline/problems/lora/sgemm_lora_a/cases.py)
# ---------------------------------------------------------------------------
...
def _case(
    ...
    return dict(
        x=x, weights=weights, batch_info=batch_info, stack_num=stack_num
    )
...
def test_sgemm_lora_a(case_idx):
    ...
    # Operator under test
    try:
        from flaggems_sglang import sgemm_lora_a
    except (ImportError, ModuleNotFoundError):
        pytest.skip("lora/sgemm_lora_a ops module not found")
        return

    try:
        actual = sgemm_lora_a(**kwargs)
    except NotImplementedError:
        pytest.skip("lora/sgemm_lora_a not yet implemented")
        return
